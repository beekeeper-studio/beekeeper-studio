      ...
      <div class="filter">
        <div class="filter-wrap">
          ...
          <x-buttons class="filter-actions">
            <x-button @click="clearFilter" v-if="filterQuery"
              ><i class="clear material-icons">cancel</i></x-button
            >
            <x-button
      ...
      <nav class="list-group flex-col">
        <div class="list-heading row">
          <div class="sub row flex-middle expand">
            ...
            <div>
              Pinned <span class="badge">{{ orderedPins.length }}</span>
            </div>
          </div>
          <!-- <div class="actions">
        ...
        <div class="list-heading row">
          <div class="sub row flex-middle expand">
            ...
            <div>
              ...
              >
              <span
                :title="`${hiddenEntities} hidden by filters`"
                class="badge"
                v-if="hiddenEntities"
                :class="{ active: entitiesHidden }"
