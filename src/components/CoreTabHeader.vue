    ...
    <li class="nav-item" :title="title + scope">
      ...
      >
        <i
          v-if="tab.type === 'table'"
          :class="iconClass"
          class="material-icons item-icon table"
          >grid_on</i
        >
        <i v-if="tab.type === 'query'" class="material-icons item-icon query"
          >code</i
        >
        <i
          v-if="tab.type === 'table-properties'"
          class="material-icons item-icon table-properties"
          :class="iconClass"
          >lightbulb</i
        >
        <i
          ...
          >settings</i
        >
        <span class="tab-title truncate" :title="title + scope" ref="tabTitle">
          <span> {{ title }}</span>
        ...
        <div class="tab-action">
          <span
            class="tab-close"
            :class="{ unsaved: tab.unsavedChanges }"
            @mousedown.stop="doNothing"
            @click.prevent.stop="$emit('close', tab)"
          >
