---
title: Actualizar Desde la Edicion Comunitaria
description: Como (y por que) actualizar Beekeeper Studio de la edicion comunitaria gratuita a la version completa de pago.
summary: "Como actualizar la edicion comunitaria de Beekeeper Studio a la version comercial completa."
...
![Visor de filas JSON](../assets/images/json-row-view.png)
