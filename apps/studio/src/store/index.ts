...
const store = new Vuex.Store<State>({
      ...
      switch (data.type) {
        case "creation":
          if (
            ...
            state.explorer.nodeActions.creationInstance.state.creationTrigger =
              false;
          }
          state.explorer.nodeActions.creationInstance = data.instance;
          break;
        case "rename":
          if (
            ...
            state.explorer.nodeActions.renameInstance.state.renameTrigger =
              false;
          }
          state.explorer.nodeActions.renameInstance = data.instance;
          break;
  ...
  actions: {
    ...
    async updateRoutines(context) {
      ...
      const connection = context.state.connection;
      const routines: Routine[] = await connection.listRoutines({
        schema: null,
      });
