...
/** A set of types related to args for plugin menu items. */
export namespace PluginMenu {
  ...
  export type RowArgs = { target: RowTarget; activeRange: ActiveRange };

  export type CornerArgs = {
    target: CornerTarget;
    activeRange: ActiveRange;
  };
}
