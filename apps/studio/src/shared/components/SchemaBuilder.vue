<template>
  <div class="schema-builder">
    ...
    <div id="tabulator-goes-here" ref="tabulator" />
  </div>
</template>
  ...
  computed: {
    ...
    tableColumns() {
      ...
      const dataColumns = [
        ...
        this.disabledFeatures?.nullable
          ? null
          : {
              title: "Nullable",
              field: "nullable",
        ...
        this.disabledFeatures?.defaultValue
          ? null
          : {
              title: "Default Value",
              field: "defaultValue",
              ...
              tooltip: true,
              headerTooltip:
                "The default value of this field. Be sure to add quotes around literal values - eg 'my value'",
              formatter: this.cellFormatter,
              widthShrink: 1,
              minWidth: 100,
            },
      ...
      return editable
        ? [
            ...
            ...dataColumns,
            {
              ...
              minWidth: 36,
              hozAlign: "center",
              cellClick: editable ? this.removeRow : undefined,
              resizable: false,
  ...
  methods: {
    ...
    async addRow() {
      ...
      const defaultDataType =
        getDialectData(this.dialect).defaultColumnType || "varchar(255)";

      const row: RowComponent = await this.tabulator.addRow({
        columnName,
...
@use "../../shared/assets/styles/_extends" as *;
$row-height: 42px;
$min-cell-width: 24px;
$cell-font-size: 14px;
$cell-padding: 0.6rem;
