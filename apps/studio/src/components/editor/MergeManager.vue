<template>
  <div class="merge-manager">
      <div v-if="pendingMerge" class="alert alert-notice">
        <span class="message">
          <i class="material-icons">info_outlined</i> Merge Completed
        </span>
        <span class="actions">
      ...
      <div v-else-if="pendingRemoteChanges" class="alert alert-warning">
        <span class="message">
          <i class="material-icons">warning_outlined</i> This query has been updated by someone else.
        </span>
      ...
      <modal name="diff-modal" class="beekeeper-modal vue-dialog" >
