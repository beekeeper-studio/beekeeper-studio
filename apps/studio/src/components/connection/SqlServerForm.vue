<template>
  <div class="with-connection-type">
    ...
    <div class="advanced-connection-settings">
      <h4 class="advanced-heading">SQL Server Options</h4>
      <div class="advanced-body">
        ...
        <div class="form-group">
          <label for="trustServerCertificate" class="checkbox-group">
            ...
            <i class="material-icons" v-tooltip="'Use this for local dev servers and self-signed certificates. ssl -> rejectUnauthorized overrides this setting if ssl is enabled'">help_outlined</i>
          </label>
        </div>
