<template>
  <div class="duckdb-form">
    <div class="alert alert-warning">
      ...
      <span>
        {{ $t('DuckDB support is still in beta. Please report any problems on') }} <a href="https://github.com/beekeeper-studio/beekeeper-studio/issues/new/choose">{{ $t('our issue tracker') }}</a>.
      </span>
    </div>
