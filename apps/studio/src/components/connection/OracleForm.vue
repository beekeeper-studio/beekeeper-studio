<template>
  <div class="with-connection-type oracledb-form">
    ...
    <template v-else>
      ...
      <div>
        <p>Unfortunately, Oracle does not publish a version of the 'Oracle Instant Client' for Apple Silicon.</p>
        <p class="">
          Please download the Intel version of the <a
            href="https://www.oracle.com/database/technologies/instant-client.html"
            class=""
          >Oracle Instant Client</a>, and use the <a
            href="https://beekeeperstudio.io/get"
            class=""
          >Intel build of Beekeeper Studio</a> in order to connect to an Oracle Database.
        </p>
      </div>
    </template>
  </div>
