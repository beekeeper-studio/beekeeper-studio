  ...
  <div class="home">
    <section class="subheader">
      <div class="small-wrap">
        <h1>SQLTools</h1>
        <div class="subtitle">
          SQLTools is a collection of useful utilities for relational databases from the makers of <a
            class="text-primary"
            href="https://beekeeperstudio.io"
            target="_blank"
          >Beekeeper Studio</a>. These tools are all free and open source, contain no creepy tracking, and non of the data you enter will be sent to our servers.
        </div>
      </div>
    </section>
    ...
    <section class="promise">
      <div class="small-wrap">
        <h2>Our Promise</h2>
        <p>
          SQLTools is made by <a
            href="https://beekeeperstudio.io"
            target="_blank"
            class="text-primary"
          >Beekeeper Studio</a> and is 100% MIT open source and free. We promise to keep it that way.
        </p>
        <p>We are</p>
        <ul>
        ...
        <p>
          <a
            ...
            target="_blank"
            class="text-primary"
          >Beekeeper Studio</a> is an open source and free SQL management app available for Linux, MacOS and Windows. Many SQLTools utilities are also part of the Beekeeper Studio app, but we thought they might be useful to the rest of the internet too.
        </p>
      </div>
    </section>
  </div>
