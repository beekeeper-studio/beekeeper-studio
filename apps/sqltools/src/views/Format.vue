  ...
  <div class="format">
    <section class="subheader">
      <div class="small-wrap">
        ...
        <div class="subtitle">
          Quickly format your SQL query by pasting (or typing) it in the box below. Code generation is done client-side, no data is transferred to our servers. We're committed to <a
            class="text-primary"
            href="https://www.beekeeperstudio.io/mission/"
            target="_blank"
          >privacy, and just not being creepy</a>.
        </div>
      </div>
    </section>
    <section>
