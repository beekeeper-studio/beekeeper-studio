...
export type ContextMenuExtension<Context = unknown> = (event: Event, defaultItems: InternalContextItem<Context>[], context: Context) => { items: InternalContextItem[]; context: Context };
