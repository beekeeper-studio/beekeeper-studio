  ...
  return [
    ...
    EditorView.theme({
      ...
      ".cm-lineNumbers .cm-activeLineGutter": {
        color: "var(--text-editor-linenumber-active-fg)",
      },
      // Focused state
      "&.cm-focused": {
      ...
      "&.cm-editor[data-vim-mode=normal] .cm-panels .cm-panel.cm-vim-panel": {
        backgroundColor: "var(--text-editor-vim-panel-normal-bg)",
        color: "var(--text-editor-vim-panel-normal-fg)",
      },
      "&.cm-editor[data-vim-mode=insert] .cm-panels .cm-panel.cm-vim-panel": {
        backgroundColor: "var(--text-editor-vim-panel-insert-bg)",
        color: "var(--text-editor-vim-panel-insert-fg)",
      },
      "&.cm-editor[data-vim-mode=visual] .cm-panels .cm-panel.cm-vim-panel": {
        backgroundColor: "var(--text-editor-vim-panel-visual-bg)",
        color: "var(--text-editor-vim-panel-visual-fg)",
      },
      "&.cm-editor[data-vim-mode=replace] .cm-panels .cm-panel.cm-vim-panel": {
        backgroundColor: "var(--text-editor-vim-panel-replace-bg)",
        color: "var(--text-editor-vim-panel-replace-fg)",
      },
