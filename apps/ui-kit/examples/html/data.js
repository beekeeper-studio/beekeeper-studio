const cheeses = {
  ...
  columns: [
    ...
    { name: "origin_country_id", dataType: "integer", foreignKey: true },
    { name: "cheese_type", dataType: "string" },
...
const postUser = {
  ...
  schema: "public",
  columns: [
    { name: "postId", dataType: "integer", foreignKey: true, toTable: posts },
    { name: "userId", dataType: "integer", foreignKey: true, toTable: users },
  ],
  data: [
...
const commentUserPost = {
  ...
  schema: "public",
  columns: [
    { name: "commentId", dataType: "integer", foreignKey: true, toTable: comments },
    { name: "postId", dataType: "integer", foreignKey: true, toTable: posts },
    { name: "userId", dataType: "integer", foreignKey: true, toTable: users },
  ],
  data: [
...
window.tables = [cheeses, users, posts, comments, postUser, commentUserPost];
